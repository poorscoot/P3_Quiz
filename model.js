...
//Modelo de datos
//
//En esta variable se mantienen todos los quizzes eistentes.
//Es un array de objetos, donde cada objeto tiene los atributos question
//y awnser para guardar el texto de la pregunta y de la respuesta.
//
//Al arrancar la aplicación, esta variable contiene estas cuatro preguntas
//pero al final del módulo se llama load() para la cargar las preguntas
...
*quizzes. El contenido de este fichero esá en formato JSON.
*La primera vez que se ejecute este método, el fichero DB_FILENAME no
*existe, y se producirá elerror ENOENT. En este caso se salva el
*contenido inicial almacenado en quizzes.
*Si se porduce ortro tipo de error, se lanza una excepción que abortará
...
*	@param awnser String con la respuesta.
*/
...
/**
*Devuelve los quizzes existentes.
*
*Devuelve un clon de valor guardado en la variable quizzes, es decir, devuelve un 
...
*
*	@param id Clave dque identifica el quiz a devolver.
*
